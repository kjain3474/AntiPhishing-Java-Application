...
public class NewClass1 extends JFrame implements ActionListener {
     ...
     Connection cn = null;
       ...
       ResultSet rs = null;
     JButton jb;
    NewClass1() throws SQLException, ClassNotFoundException, Exception 
{
...
try
{
    String url = "jdbc:mysql://127.0.0.1:3306/";
        ...
        stmt.execute("SELECT * FROM PHISH");
...
table.setCellSelectionEnabled(true);
 ...
 //System.out.println("Selected: " );
        ...
        System.out.println("Sele: " + selected);
          try {
              stmt.execute( "SELECT * FROM PHISH WHERE PID="+(selected+1)+";");
    ...
    {         
        Object b = e.getSource();
            ...
            maildisplay md =new maildisplay();
                md.display1(selected,"newclass1");
                md.setVisible(true);
                setVisible(false);
            }
